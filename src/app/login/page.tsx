  ...
  return (
    <div className="min-h-screen bg-[#fafafa] flex flex-col justify-between p-4 sm:p-6 text-neutral-900 selection:bg-blue-500/20 font-sans">
      ...
      <div className="flex items-center justify-between max-w-4xl mx-auto w-full">
        ...
        <Link
          href="/"
          className="text-xs font-semibold text-neutral-600 hover:text-neutral-900 transition-colors flex items-center gap-1.5"
        >
      ...
      <div className="max-w-md w-full mx-auto my-auto space-y-4">
        ...
        <div className="p-4 rounded-2xl bg-white border border-neutral-200/80 shadow-xs flex items-center justify-between gap-3 text-left">
          <div>
            <div className="text-xs font-bold text-neutral-900">Hosting a standard meeting?</div>
            <div className="text-[11px] text-neutral-500">Zero login or account required — powered by JUMMP Meet.</div>
          </div>
          <Link
            href="/"
        ...
        <div className="bg-white rounded-3xl border border-neutral-200/80 p-6 sm:p-8 shadow-xl text-left">
          {/* Pro Account Tag (Apple-style minimal rectangular badge) */}
          <div className="mb-5 inline-flex items-center gap-1.5 px-3 py-1 rounded-lg bg-neutral-100 border border-neutral-200 text-neutral-800 text-[11px] font-bold tracking-wider uppercase">
            <Sparkles className="w-3 h-3 text-[#0b5cff]" />
          ...
          <div className="mt-6 pt-4 border-t border-neutral-100 flex items-center justify-between text-xs text-neutral-500">
            ...
            <Link href="/pricing" className="font-bold text-[#0b5cff] hover:underline">
              View Plans →
            </Link>
          </div>
        </div>
